...
/**
 * This class contains necesary methods to show the cookies in the application
 * @author erick
 * @version 1.0.0
 */
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String htmlPage = "<!DOCTYPE html>\n"
                    ...
                    + "                            <a class=\"nav-link active\" data-toggle=\"tab\" href=\"#simbolos\">Cookies</a>\n"
                    + "                        </li>\n"
                    + "                    </ul>\n"
            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    if (cookie.getName().equals("numOfSolvesBellman")) {
                        ...
                        htmlPage += "<tr>"
                                + "<td>" + "numOfSolvesBellman" + "</td>" + "<td>" + "It has been used " + numOfSolvesBellman + " times</td>"
                                + "</tr>";
                    } else if (cookie.getName().equals("numOfSolvesDijkstra")) {
                        numOfSolvesDijkstra = Integer.parseInt(cookie.getValue());
                        htmlPage += "<tr>"
                                + "<td>" + "numOfSolvesDijkstra" + "</td>" + "<td>" + "It has been used " + numOfSolvesDijkstra + " times</td>"
                                + "</tr>";
                    } else if (cookie.getName().equals("solvingPage")) {
                        solvingPage = Integer.parseInt(cookie.getValue());
                        htmlPage += "<tr>"
                                + "<td>" + "solvingPage" + "</td>" + "<td>" + "It has been used " + solvingPage + " times</td>"
                                + "</tr>";
                    }
                }
            }
            ...
            out.println("An error has been ocurred');");
            out.println("</script>");
        }
    }
